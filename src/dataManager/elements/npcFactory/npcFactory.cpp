...
NPC *NPCFactory::getfairy(int x, int y) {
  ...
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
...
NPC *NPCFactory::getprincess(int x, int y) {
  ...
  string name = "公主";
  // set the words of the NPC
  string words = "勇士，感谢你来救我！这里的神秘药水可以使你的生命值翻倍，快喝"
                 "了它去击败恶龙吧！";
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
...
NPC *NPCFactory::getold_man_level5(int x, int y) {
  ...
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
      new TradeButton(TradeButton::EXP, TradeButton::LEVEL, 100, 1,
                      Game::transaction),
      new TradeButton(TradeButton::EXP, TradeButton::ATTACK, 30, 5,
                      Game::transaction),
      new TradeButton(TradeButton::EXP, TradeButton::DEFENCE, 30, 5,
                      Game::transaction),
  }));
  // get a new NPC
...
NPC *NPCFactory::getold_man_level13(int x, int y) {
  ...
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
      new TradeButton(TradeButton::EXP, TradeButton::LEVEL, 270, 3,
                      Game::transaction),
      new TradeButton(TradeButton::EXP, TradeButton::ATTACK, 95, 17,
                      Game::transaction),
      new TradeButton(TradeButton::EXP, TradeButton::DEFENCE, 95, 17,
                      Game::transaction),
  }));
  // get a new NPC
...
NPC *NPCFactory::getstone_level3(int x, int y) {
  ...
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
      new TradeButton(TradeButton::MONEY, TradeButton::HEALTH, 25, 800,
                      Game::transaction),
      new TradeButton(TradeButton::MONEY, TradeButton::ATTACK, 25, 4,
                      Game::transaction),
      new TradeButton(TradeButton::MONEY, TradeButton::DEFENCE, 25, 4,
                      Game::transaction),
  }));
  // get a new NPC
...
NPC *NPCFactory::getstone_level11(int x, int y) {
  ...
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
      new TradeButton(TradeButton::MONEY, TradeButton::HEALTH, 100, 4000,
                      Game::transaction),
      new TradeButton(TradeButton::MONEY, TradeButton::ATTACK, 100, 20,
                      Game::transaction),
      new TradeButton(TradeButton::MONEY, TradeButton::DEFENCE, 100, 20,
                      Game::transaction),
  }));
  // get a new NPC
...
NPC *NPCFactory::getkey_seller(int x, int y) {
  ...
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
      new TradeButton(TradeButton::MONEY, TradeButton::YELLOWKEY, 10, 1,
                      Game::transaction),
      new TradeButton(TradeButton::MONEY, TradeButton::BLUEKEY, 50, 1,
                      Game::transaction),
      new TradeButton(TradeButton::MONEY, TradeButton::REDKEY, 100, 1,
                      Game::transaction),
  }));
  // get a new NPC
...
NPC *NPCFactory::getkey_buyer(int x, int y) {
  ...
  // insert the buttons into a new UI
  TalkingUI *ui = new TalkingUI(LinkedList<TradeButton *>({
      new TradeButton(TradeButton::YELLOW, TradeButton::COIN, 1, 7,
                      Game::transaction),
      new TradeButton(TradeButton::BLUE, TradeButton::COIN, 1, 35,
                      Game::transaction),
      new TradeButton(TradeButton::RED, TradeButton::COIN, 1, 70,
                      Game::transaction),
  }));
  // get a new NPC
