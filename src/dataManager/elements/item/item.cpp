...
Item::Item(ID id) : Cell(id, Type::ITEM) {
  printf("DEBUG: Entering item.cpp::Type::ITEM)\n");

  printf("DEBUG: Exiting item.cpp::Type::ITEM)\n");
}

Item::~Item() {}

void Item::effect(DataManager *dataManager) {
  printf("DEBUG: Entering item.cpp::*dataManager)\n");
  ...
  printf("DEBUG: Exiting item.cpp::*dataManager)\n");
}