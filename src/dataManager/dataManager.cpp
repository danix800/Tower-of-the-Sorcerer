...
Map *DataManager::getMap() { return maps[towerLevel]; }

Hero *DataManager::getHero() { return hero; }

int DataManager::getTowerLevel() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::getTowerLevel\n");
  return towerLevel;

  printf("DEBUG: Exiting dataManager.cpp::DataManager::getTowerLevel\n");
}

int DataManager::getHighestLevel() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::getHighestLevel\n");
  return highestLevel;

  printf("DEBUG: Exiting dataManager.cpp::DataManager::getHighestLevel\n");
}

int DataManager::getRedKeys() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::getRedKeys\n");
  return redKeys;

  printf("DEBUG: Exiting dataManager.cpp::DataManager::getRedKeys\n");
}

int DataManager::getBlueKeys() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::getBlueKeys\n");
  return blueKeys;

  printf("DEBUG: Exiting dataManager.cpp::DataManager::getBlueKeys\n");
}

int DataManager::getYellowKeys() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::getYellowKeys\n");
  return yellowKeys;

  printf("DEBUG: Exiting dataManager.cpp::DataManager::getYellowKeys\n");
}
...
void DataManager::setMaps(LinkedList<Map *> maps) {
  printf("DEBUG: Entering dataManager.cpp::maps)\n");
  ...
  printf("DEBUG: Exiting dataManager.cpp::maps)\n");
}

void DataManager::initGameData() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::initGameData\n");
  // free memory of hero
  if (hero)
    delete hero;
  // init hero
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::initGameData\n");
}

void DataManager::saveGameData() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::saveGameData\n");
  // save maps
  ...
  for (Node<Map *> *p = ResourceManager::Saved_Maps.begin(); p;
       p = p->getNext())
    delete p->getValue();
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::saveGameData\n");
}

void DataManager::saveHeroInfo() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::saveHeroInfo\n");
  // open a file to write
  ofstream *out = new ofstream("./res/save/info", ios::binary);
  // get list of data
  int infoList[] = {hero->getLevel(),
                    hero->getHealth(),
                    hero->getAttack(),
                    hero->getDefence(),
                    hero->getMoney(),
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::saveHeroInfo\n");
}

void DataManager::loadHeroInfo() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::loadHeroInfo\n");
  // set hero direction
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::loadHeroInfo\n");
}

void DataManager::moveHero(Hero::Direction direction) {
  printf("DEBUG: Entering dataManager.cpp::direction)\n");
  ...
  printf("DEBUG: Exiting dataManager.cpp::direction)\n");
}

void DataManager::stopHero() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::stopHero\n");
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::stopHero\n");
}

bool DataManager::inBound(int x, int y) {
  printf("DEBUG: Entering dataManager.cpp::y)\n");
  return (x >= 0 && x < Map::getMatrixWidth()) &&
         (y >= 0 && y < Map::getMatrixWidth());

  printf("DEBUG: Exiting dataManager.cpp::y)\n");
}

void DataManager::HeroBeginFight() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::HeroBeginFight\n");
  // get map
  Map *map = maps[towerLevel];
  // get the enemy
  Enemy *enemy =
      (Enemy *)map->getCellAt(hero->getCurrentX(), hero->getCurrentY());
  // attack the enemy
  hero->attackEnemy(enemy);
  // adjust the fight state
  hero->setFightState(Hero::FIGHTING);

  printf("DEBUG: Exiting dataManager.cpp::DataManager::HeroBeginFight\n");
}

void DataManager::HeroStopFight() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::HeroStopFight\n");
  // get map
  Map *map = maps[towerLevel];
  // get the enemy
  Enemy *enemy =
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::HeroStopFight\n");
}

void DataManager::removeDoor(Door *door) {
  printf("DEBUG: Entering dataManager.cpp::*door)\n");
  // remove the door in the door list
  maps[towerLevel]->removeDoor(door);
  // make the hero can move again
  hero->setWaiting(false);

  printf("DEBUG: Exiting dataManager.cpp::*door)\n");
}

void DataManager::addKeys(int red, int blue, int yellow) {
  printf("DEBUG: Entering dataManager.cpp::yellow)\n");
  redKeys += red;
  blueKeys += blue;
  yellowKeys += yellow;

  printf("DEBUG: Exiting dataManager.cpp::yellow)\n");
}

void DataManager::goUpStairs() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::goUpStairs\n");
  // go to next level
  towerLevel++;
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::goUpStairs\n");
}

void DataManager::goDownStairs() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::goDownStairs\n");
  ...
  printf("DEBUG: Exiting dataManager.cpp::DataManager::goDownStairs\n");
}

void DataManager::transportTo(int dst) {
  printf("DEBUG: Entering dataManager.cpp::dst)\n");
  towerLevel = dst - 1;
  goUpStairs();

  printf("DEBUG: Exiting dataManager.cpp::dst)\n");
}
...
void DataManager::stopTalking() {
  printf("DEBUG: Entering dataManager.cpp::DataManager::stopTalking\n");
  hero->setWaiting(false);

  printf("DEBUG: Exiting dataManager.cpp::DataManager::stopTalking\n");
}

void DataManager::transaction(TradeButton::Currency currency,
                              TradeButton::Goods goods, int cost, int gain) {
  printf("DEBUG: Entering dataManager.cpp::gain)\n");
  ...
  if (currency == TradeButton::MONEY) {
    ...
    printf("DEBUG: Entering dataManager.cpp::TradeButton::EXP)\n");
    int left = hero->getExp() - cost;
    canAfford = (left >= 0);
    if (canAfford)
      hero->setExp(left);

    printf("DEBUG: Exiting dataManager.cpp::TradeButton::EXP)\n");
  } else if (currency == TradeButton::RED) {
    printf("DEBUG: Entering dataManager.cpp::TradeButton::RED)\n");
    int left = redKeys - cost;
    canAfford = (left >= 0);
    if (canAfford)
      redKeys = left;

    printf("DEBUG: Exiting dataManager.cpp::TradeButton::RED)\n");
  } else if (currency == TradeButton::BLUE) {
    printf("DEBUG: Entering dataManager.cpp::TradeButton::BLUE)\n");
    int left = blueKeys - cost;
    canAfford = (left >= 0);
    if (canAfford)
      blueKeys = left;

    printf("DEBUG: Exiting dataManager.cpp::TradeButton::BLUE)\n");
  } else if (currency == TradeButton::YELLOW) {
    printf("DEBUG: Entering dataManager.cpp::TradeButton::YELLOW)\n");
    int left = yellowKeys - cost;
    canAfford = (left >= 0);
    if (canAfford)
      yellowKeys = left;

    printf("DEBUG: Exiting dataManager.cpp::TradeButton::YELLOW)\n");
  }

  // if can afford, get the goods
  if (canAfford) {
    printf("DEBUG: Entering dataManager.cpp::\n");
    ...
    printf("DEBUG: Exiting dataManager.cpp::\n");
  }

  printf("DEBUG: Exiting dataManager.cpp::gain)\n");
}