...
void Shape::draw_lines() const {
  printf("DEBUG: Entering Graph.cpp::const\n");
  if (color().visibility() && 1 < points.size()) // draw sole pixel?
    for (unsigned int i = 1; i < points.size(); ++i)
      fl_line(points[i - 1].x, points[i - 1].y, points[i].x, points[i].y);

  printf("DEBUG: Exiting Graph.cpp::const\n");
}
...
void Lines::add(Point p1, Point p2) {
  printf("DEBUG: Entering Graph.cpp::p2)\n");
  Shape::add(p1);
  Shape::add(p2);

  printf("DEBUG: Exiting Graph.cpp::p2)\n");
}
...
bool line_segment_intersect(Point p1, Point p2, Point p3, Point p4,
                            Point &intersection) {
  printf("DEBUG: Entering Graph.cpp::intersection)\n");
  bool parallel;
  ...
  printf("DEBUG: Exiting Graph.cpp::intersection)\n");
}

//------------------------------------------------------------------------------

void Polygon::add(Point p) {
  printf("DEBUG: Entering Graph.cpp::p)\n");
  ...
  printf("DEBUG: Exiting Graph.cpp::p)\n");
}
...
void draw_mark(Point xy, char c) {
  printf("DEBUG: Entering Graph.cpp::c)\n");
  ...
  printf("DEBUG: Exiting Graph.cpp::c)\n");
}
...
Circle::Circle(Point p, int rr) // center and radius
    : r(rr) {
  printf("DEBUG: Entering Graph.cpp:::r\n");
  add(Point(p.x - r, p.y - r)); // store top-left corner

  printf("DEBUG: Exiting Graph.cpp:::r\n");
}
...
void Axis::move(int dx, int dy) {
  printf("DEBUG: Entering Graph.cpp::dy)\n");
  Shape::move(dx, dy);
  notches.move(dx, dy);
  label.move(dx, dy);

  printf("DEBUG: Exiting Graph.cpp::dy)\n");
}
...
Suffix::Encoding get_encoding(const string &s) {
  printf("DEBUG: Entering Graph.cpp::s)\n");
  struct SuffixMap {
  ...
  printf("DEBUG: Exiting Graph.cpp::s)\n");
}
