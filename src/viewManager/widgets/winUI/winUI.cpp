...
WinUI::WinUI() : Fl_Group(WINUI_X, WINUI_Y, WINUI_WIDTH, WINUI_HEIGHT) {
  printf("DEBUG: Entering winUI.cpp::WINUI_HEIGHT)\n");
  // set style
  ...
  button = new Fl_Button(WIN_BUTTONX, WIN_BUTTONY, WIN_BUTTONW, WIN_BUTTONH,
                         "返回主菜单");
  // set style
  ...
  printf("DEBUG: Exiting winUI.cpp::WINUI_HEIGHT)\n");
}
